...
export const list:Question[] = [
    ...
    },
    {
        ...
        type: QuestionType.Radio,
        answers: [
            { id: 21, answer: "Можна", isCorrect: false, points: 5 },
            { id: 22, answer: "Не можна", isCorrect: false, points: 0 },
            { id: 23, answer: "Можна але обережно", isCorrect: true, points: 0 },
        ],
    },
    {
        id: 3,
        ...
        answers: [
            { id: 31, answer: "Користуватися мобільним телефоном", isCorrect: false, points: 5 },
            { id: 32, answer: "Знати тільки число та місто", isCorrect: false, points: 0 },
            { id: 33, answer: "Користуватися читальником", isCorrect: true, points: 0 },
            { id: 34, answer: "Користуватися паспортом-печаткою", isCorrect: true, points: 0 },
        ],
    },
    {
        id: 4,
    ...
    },
    {
        ...
        answers: [
            ...
            { id: 54, answer: "Користуватися паспортом-печаткою", isCorrect: true, points: 0 },
        ],
    }
]
